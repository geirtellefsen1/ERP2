    ...
    try {
      const [dash, ai] = await Promise.all([
        ...
        apiGet<AiActivityItem[]>(
          `/api/v1/hospitality/ai-activity?since_hours=72&limit=20`
        ),
      ])
      setData(dash)
      setActivity(ai)
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          ...
          · {data.outlets.length} outlets · currency {data.currency}
        </p>
      </div>
      ...
      {/* AI activity feed — the "since you last logged in" panel */}
      ...
      {/* Room categories + outlets reference */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <CardHeader>
