/**
 * Brand-correct SVG icons for third-party providers.
 * Inline SVGs so we don't need an icon library or external image hosting.
 * Defaults to 16px (h-4 w-4). Override with className.
 */
